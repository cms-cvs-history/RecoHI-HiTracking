...
process.hiGoodTightTrkVal = process.hitrkvalidator.clone(trklabel=cms.untracked.InputTag("hiSelectedTracks"))
process.hiGlobalPrimTrkVal = process.hitrkvalidator.clone(trklabel=cms.untracked.InputTag("hiGlobalPrimTracks"))
process.hiScndSelectedTrkVal = process.hitrkvalidator.clone(trklabel=cms.untracked.InputTag("hiScndSelectedTracks"))
process.hiThrdSelectedTrkVal = process.hitrkvalidator.clone(trklabel=cms.untracked.InputTag("hiThrdSelectedTracks"))
...
process.hiValidatorSequence = cms.Sequence(
    ...
    process.hiSelectedTrkVal*
    process.hiGlobalPrimTrkVal*
    process.hiScndSelectedTrkVal*
    process.hiThrdSelectedTrkVal*
...
process.hitrkEffAnalyzer_hiSelected = hitrkEffAnalyzer_akpu3pf
process.hitrkEffAnalyzer_hiSelected.jets = 'icPu5patJets'
process.hitrkEffAnalyzer_hiSelected.tracks = 'hiSelectedTracks'
#process.hitrkEffAnalyzer_hiSelected.fillNtuples = True
process.hitrkEffAnalyzer_hiSelected.useQaulityStr = cms.untracked.bool(False)


process.hitrkEffAnalyzer_hiGlobalPrim = process.hitrkEffAnalyzer_hiSelected.clone(tracks = 'hiGlobalPrimTracks')
process.hitrkEffAnalyzer_hiScndSelected = process.hitrkEffAnalyzer_hiSelected.clone(tracks = 'hiScndSelectedTracks')
process.hitrkEffAnalyzer_hiThrdSelected = process.hitrkEffAnalyzer_hiSelected.clone(tracks = 'hiThrdSelectedTracks')
process.hitrkEffAnalyzer_hiGeneralTracks = process.hitrkEffAnalyzer_hiSelected.clone(tracks = 'hiGeneralTracks')
...
process.hitrkEffAna = cms.Sequence(process.cutsTPForFak*process.cutsTPForEff*
                                   ...
                                   process.hitrkEffAnalyzer_hiSelected*
                                   process.hitrkEffAnalyzer_hiScndSelected*
                                   process.hitrkEffAnalyzer_hiThrdSelected*
